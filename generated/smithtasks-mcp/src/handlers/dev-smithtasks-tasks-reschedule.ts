...
import { getDefaultSmithTasksService, principalFromEnvironment, type RescheduleTaskInput } from "../../../../packages/smithtasks-runtime/src/index.js";
...
export async function handle(input: unknown, invocation: ToolInvocationContext): Promise<JSONValue> {
  const result = await getDefaultSmithTasksService().reschedule(input as RescheduleTaskInput, {
